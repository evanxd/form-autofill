...
(function(window, document) {
  ...
  FormFields.prototype = {
    ...
    _rules: {
      ...
      city: ['input[placeholder="City"]', 'input[name="enterAddressCity"]'],
      postalCode: ['input[placeholder="Postal code"]', 'input[name="enterAddressPostalCode"]']
    },
